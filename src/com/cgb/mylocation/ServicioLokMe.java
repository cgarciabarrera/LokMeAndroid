...
public class ServicioLokMe extends Service {
	...
	public class SendPosition extends AsyncTask<String, String, String> 
	{
		...
		protected String doInBackground(String... arg0) {
			...
			long a= System.currentTimeMillis() - Funciones.UltimoTimeStampEnvio;
			
			if (a > 20000)
				
				
			//if (Funciones.UltimoTimeStampEnvio==0)
			{
				...
				try {
					...
					Funciones.UltimoTimeStampEnvio= System.currentTimeMillis();
